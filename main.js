...
document.write(`Вивводимо createDomElement: ` + createDomElement('p', 'This paragraph has been added to the specified container.', container) + '<br>');
...
function getUserInfo(key) {
  if(sessionStorage.getItem(key) === null) return 'Ключ не знайденно';
...
document.write(getUserInfo('username') + "<br>");
console.log(getUserInfo('usernamee'));
document.write(getUserInfo('usernamee') + "<br>");
